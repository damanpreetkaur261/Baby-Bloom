        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" aria-label="Visit our Facebook page" className="text-stone-400 hover:text-white transition-colors"><Facebook className="w-5 h-5" /></a>
              <a href="#" aria-label="Visit our Instagram page" className="text-stone-400 hover:text-white transition-colors"><Instagram className="w-5 h-5" /></a>
              <a href="#" aria-label="Visit our Pinterest page" className="text-stone-400 hover:text-white transition-colors"><Pin className="w-5 h-5" /></a>
              <a href="#" aria-label="Visit our YouTube channel" className="text-stone-400 hover:text-white transition-colors"><Youtube className="w-5 h-5" /></a>
            </div>
