...
export default function Products() {
  ...
  const schema = {
    ...
    "@type": "CollectionPage",
    "name": "Baby Products Collection | Baby Bloom",
    "description": "Shop our collection of premium baby products including nursery essentials, feeding items, and toys.",
    "url": "https://babybloom-52.netlify.app/products"
  };
