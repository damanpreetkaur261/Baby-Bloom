...
export default function Checkout() {
  ...
  if (isSuccess) {
    return (
      <div className="bg-stone-50 py-16 md:py-24 min-h-[70vh] flex flex-col items-center justify-center px-4">
        <SEO 
          title="Order Complete | Baby Bloom"
          description="Thank you for your purchase from Baby Bloom."
          canonical="/checkout"
        />
        <motion.div 
  ...
  if (cart.length === 0) {
    return (
      <div className="bg-stone-50 py-16 md:py-24 min-h-[70vh] flex flex-col items-center justify-center px-4">
        <SEO 
          title="Checkout | Baby Bloom"
          description="Complete your purchase of premium baby essentials at Baby Bloom."
          canonical="/checkout"
        />
  ...
  return (
    <div className="bg-stone-50 py-16">
      <SEO 
        title="Checkout | Baby Bloom"
        description="Securely complete your purchase of premium baby essentials at Baby Bloom."
        canonical="/checkout"
      />
          ...
          >
            <form id="checkout-form" onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 flex flex-col gap-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input required type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div>
                    <label htmlFor="lastName" className="block text-sm font-medium text-stone-700 mb-1.5">Last Name</label>
                    <input required type="text" id="lastName" name="lastName" value={formData.lastName} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div className="md:col-span-2">
                    <label htmlFor="email" className="block text-sm font-medium text-stone-700 mb-1.5">Email Address</label>
                    <input required type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div className="md:col-span-2">
                    <label htmlFor="address" className="block text-sm font-medium text-stone-700 mb-1.5">Street Address</label>
                    <input required type="text" id="address" name="address" value={formData.address} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div>
                    <label htmlFor="city" className="block text-sm font-medium text-stone-700 mb-1.5">City</label>
                    <input required type="text" id="city" name="city" value={formData.city} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div>
                    <label htmlFor="zipCode" className="block text-sm font-medium text-stone-700 mb-1.5">ZIP Code</label>
                    <input required type="text" id="zipCode" name="zipCode" value={formData.zipCode} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="md:col-span-2">
                    <label htmlFor="cardNumber" className="block text-sm font-medium text-stone-700 mb-1.5">Card Number</label>
                    <input required type="text" id="cardNumber" name="cardNumber" placeholder="0000 0000 0000 0000" maxLength={19} value={formData.cardNumber} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div>
                    <label htmlFor="expiration" className="block text-sm font-medium text-stone-700 mb-1.5">Expiration Date</label>
                    <input required type="text" id="expiration" name="expiration" placeholder="MM/YY" maxLength={5} value={formData.expiration} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                  <div>
                    <label htmlFor="cvc" className="block text-sm font-medium text-stone-700 mb-1.5">CVC</label>
                    <input required type="text" id="cvc" name="cvc" placeholder="123" maxLength={4} value={formData.cvc} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors bg-stone-50" />
                  </div>
                </div>
              </div>
